...
function Update:Window(text,logo,keybind)
	...
	local Ngáo Gaming Hub = Instance.new("ScreenGui")
	Ngáo Gaming Hub.Name = "Ngáo Gaming Hub"
	Ngáo Gaming Hub.Parent = game.CoreGui
	Ngáo Gaming Hub.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

	local Main = Instance.new("Frame")
	Main.Name = "Main"
	Main.Parent = Ngáo Gaming Hub
...
PADOXHUBMODILE.Name = "Ngáo Gaming Hub"
PADOXHUBMODILE.Parent = game.CoreGui
PADOXHUBMODILE.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
MODILEGUIPADOXHUB.Name = "Ngáo Gaming Hub"
MODILEGUIPADOXHUB.Parent = Ngáo Gaming Hub
...
Ngáo Gaming Hub.Name = "Ngáo Gaming Hub"
Ngáo Gaming Hub.Parent = Ngáo Gaming Hub

MODILEMAGE.Name = "Ngáo Gaming Hub"
MODILEMAGE.Parent = Ngáo Gaming Hub
...
MODILEMAGE.Image = "http://www.roblox.com/asset/?id=114533845359382"
do
...
spawn(function()
    while wait() do
        pcall(function()
            wait(0.1) 
            game:GetService('TweenService'):Create(
                Ngáo Gaming Hub,TweenInfo.new(1,Enum.EasingStyle.Linear,Enum.EasingDirection.InOut),
                {TextColor3 = Color3.fromRGB(255, 0, 0)}
            ):Play() 
            wait(.5)            
            game:GetService('TweenService'):Create(
...
-------------------------------------------------------------------------------------------------------------------------
--Tab
local PadoUi = Update:Window("Ngáo gaming","",Enum.KeyCode.RightControl);
